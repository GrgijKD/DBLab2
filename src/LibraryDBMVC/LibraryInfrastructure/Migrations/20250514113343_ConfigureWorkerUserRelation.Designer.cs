...
namespace LibraryInfrastructure.Migrations
{
    ...
    [Migration("20250514113343_ConfigureWorkerUserRelation")]
    partial class ConfigureWorkerUserRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryDomain.Model.Worker", b =>
                {
                    b.HasOne("LibraryDomain.Model.ApplicationUser", "ApplicationUser")
                        .WithOne("Worker")
                        .HasForeignKey("LibraryDomain.Model.Worker", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
